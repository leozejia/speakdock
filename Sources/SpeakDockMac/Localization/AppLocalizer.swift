...
enum AppLocalizedStringKey: String {
    ...
    case settingsTermDictionaryExportButton = "settings.term_dictionary.export_button"
    ...
    case settingsTermDictionaryLearningTitle = "settings.term_dictionary.learning_title"
    case settingsTermDictionaryObservedCount = "settings.term_dictionary.observed_count"
    case settingsTermDictionaryLearningRecent = "settings.term_dictionary.learning_recent"
    case settingsTermDictionaryLearningRecentEmpty = "settings.term_dictionary.learning_recent_empty"
    case settingsTermDictionaryLearningEvidenceCount = "settings.term_dictionary.learning_evidence_count"
    case settingsTermDictionaryLearningPrivacyNote = "settings.term_dictionary.learning_privacy_note"
    case settingsTermDictionaryLearningObservedStatus = "settings.term_dictionary.learning_status.observed"
    case settingsTermDictionaryLearningPromotedStatus = "settings.term_dictionary.learning_status.promoted"
    case settingsTermDictionaryLearningConflictedStatus = "settings.term_dictionary.learning_status.conflicted"
    case settingsTermDictionaryLearningSkippedConfirmedStatus = "settings.term_dictionary.learning_status.skipped_confirmed"
    case settingsTermDictionaryLearningSingleEdit = "settings.term_dictionary.learning_single_edit"
    case settingsTermDictionaryLearningPromotion = "settings.term_dictionary.learning_promotion"
    case settingsTermDictionaryLearningConflict = "settings.term_dictionary.learning_conflict"
    ...
    case settingsASRCorrectionConfigurationTitle = "settings.asr_correction_configuration.title"
    case settingsASRCorrectionConfigurationSubtitle = "settings.asr_correction_configuration.subtitle"
    case settingsASRCorrectionProviderLabel = "settings.asr_correction_provider.label"
    case settingsASRCorrectionProviderDisabled = "settings.asr_correction_provider.disabled"
    case settingsASRCorrectionProviderOnDevice = "settings.asr_correction_provider.on_device"
    case settingsASRCorrectionProviderCustomEndpoint = "settings.asr_correction_provider.custom_endpoint"
    case settingsASRCorrectionDisabledBody = "settings.asr_correction.disabled_body"
    case settingsASRCorrectionOnDeviceBody = "settings.asr_correction.on_device_body"
    case settingsASRCorrectionCustomBody = "settings.asr_correction.custom_body"
    case settingsASRCorrectionStatusLabel = "settings.asr_correction.status_label"
    case settingsASRCorrectionStatusStarting = "settings.asr_correction.status_starting"
    case settingsASRCorrectionStatusReady = "settings.asr_correction.status_ready"
    case settingsASRCorrectionStatusExecutableUnavailable = "settings.asr_correction.status_executable_unavailable"
    ...
    case settingsTermDictionaryExported = "settings.term_dictionary.exported"
