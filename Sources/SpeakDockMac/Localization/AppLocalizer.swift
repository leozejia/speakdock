...
enum AppLocalizedStringKey: String {
    ...
    case settingsShowDockIconTitle = "settings.show_dock_icon.title"
    case settingsShowDockIconSubtitle = "settings.show_dock_icon.subtitle"
    ...
    case settingsActionsTitle = "settings.actions.title"
    case settingsActionsSubtitle = "settings.actions.subtitle"
    ...
    case settingsDockOn = "settings.dock.on"
    case settingsDockOff = "settings.dock.off"
